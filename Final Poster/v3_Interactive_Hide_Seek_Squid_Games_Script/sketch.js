/*This version has sentences from the script of the  survival drama South Korean TV show
Squid Game. In the show, contestants, all in desperate financial situations, compete 
in a series of deadly children's games for a massive cash prize. */
let rows = 40;  
let cols = 40; 
let mwidth;
let mheight;
