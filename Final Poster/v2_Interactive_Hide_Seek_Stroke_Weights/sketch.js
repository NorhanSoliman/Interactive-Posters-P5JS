/*This version has some experiments with stroke wights*/
let rows = 40;  
let cols = 40; 
let mwidth;
let mheight;
...
let strings = [
  ...
  "The best part of hiding? The thrill of being found!",
  "Some say I'm still hiding... from 2002!",
  "Stealth mode: activated!",
  "Why hide when you can blend into the shadows?",
  "Seeking: a game of patience or pure luck!",
  "Is it hiding if I’ve become part of the furniture?",
  "In Hide and Seek, silence is the best strategy!",
  "The seeker’s footsteps: heart-pounding excitement!",
  "Found you! Or did I...?"
];
...
function draw() {
  ...
  push();
  stroke(0); // Light grey color for the grid lines
...
function displayRandomStrings(arr, positions) {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    fill(colorValue); // Apply the calculated color
